    ...
    <form @submit.prevent="submit" class="space-y-6 max-w-5xl mx-auto">
      <div class="flex justify-between items-center">
        ...
        <div class="space-x-2">
          ...
          <Button type="submit" :loading="form.processing">Save Invoice</Button>
        </div>
      </div>
        ...
        <Card class="md:col-span-2">
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
              <TextArea v-model="form.notes" label="Notes" placeholder="Optional notes for the client" />
              <TextArea v-model="form.terms" label="Terms" placeholder="Payment terms" />
            </div>
          </div>
        </Card>
